...
# Overrides for OSAL configuration to fit in 512 KiB RAM
if (EXISTS "${MY_MISSION_DEFS_DIR}/${OSAL_SYSTEM_BSPTYPE}_osconfig.cmake")
    list(APPEND OSAL_CONFIGURATION_FILE "${MY_MISSION_DEFS_DIR}/${OSAL_SYSTEM_BSPTYPE}_osconfig.cmake")
endif()

set(CONFIGURATION_FILE ${MY_CONFIGURATION_FILE} PARENT_SCOPE)
