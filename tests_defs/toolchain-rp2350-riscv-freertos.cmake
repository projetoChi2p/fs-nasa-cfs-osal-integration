...
add_definitions(-DRP2350_RISCV -DCPU_FREQUENCY=150000000)
...
add_compile_options(-march=rv32ima_zicsr_zifencei_zba_zbb_zbs_zbkb_zca_zcb_zcmp)                    # For integer-only/soft-float, use rv64imac/lp64"
add_compile_options(-mabi=ilp32)
add_compile_options(-msmall-data-limit=8)
add_compile_options(-mcmodel=medlow)                      # Memory model: how sparse memory addresses can be (medlow/medany/large)
...
add_link_options(-march=rv32ima_zicsr_zifencei_zba_zbb_zbs_zbkb_zca_zcb_zcmp)                       # When using newer GCC, may require "rv64ima_zicsr_zifencei"
add_link_options(-mabi=ilp32)
...
if(OSAL_RAMDISK_FILESYSTEM_IS_MFS)
    ...
    add_definitions(-DMFS_MAX_LOCAL_ENT=18)       # One entry takes (~ 8 + MFS_MAX_FILENAME_LENGTH) bytes
    add_definitions(-DMFS_BLOCK_DATA_SIZE=512)    # Must be same as CFE_PLATFORM_ES_RAM_DISK_SECTOR_SIZE
    add_definitions(-DMFS_MAX_FILENAME_LENGTH=20) # Must be >= OSAL_CONFIG_MAX_FILE_NAME
    add_definitions(-DMFS_MAX_OPEN_FILES=54)      # Must be >= OSAL_CONFIG_MAX_NUM_OPEN_FILES+OSAL_CONFIG_MAX_NUM_OPEN_DIRS
    add_definitions(-DMFS_MAX_FILESYSTEM=14)      # Must be >= OSAL_CONFIG_MAX_FILE_SYSTEMS
endif()

# These FreeRTOS configurations are applied to FreeRTOSConfig.h.in
set (FREERTOS_PLATFORM_STACK_MIN_WORDS      256)
math(EXPR FREERTOS_PLATFORM_HEAP_SIZE_BYTES "128 * 1024") # OSAL Symbol API test allocates 128 MiB filesystem
